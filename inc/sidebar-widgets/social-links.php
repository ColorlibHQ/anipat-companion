...
class Anipat_social_links extends WP_Widget {
    ...
    function __construct() {
        ...
        esc_html__( '[ Anipat ] Social Links', 'anipat-companion' ),

        // Widget description
        array( 'description' => esc_html__( 'Add footer social links.', 'anipat-companion' ), )
        );
    ...
    public function form( $instance ) {
        ...
        $title = isset( $instance[ 'title' ] ) ? $instance[ 'title' ] : esc_html__( 'Follow Us', 'anipat-companion' );
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'facebook' ) ); ?>"><?php esc_html_e( 'Facebook URL:' ,'anipat-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'twitter' ) ); ?>"><?php esc_html_e( 'Twitter URL:' ,'anipat-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'linkedin' ) ); ?>"><?php esc_html_e( 'Linkedin URL:' ,'anipat-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'instagram' ) ); ?>"><?php esc_html_e( 'Instagram URL:' ,'anipat-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'dribbble' ) ); ?>"><?php esc_html_e( 'Dribbble URL:' ,'anipat-companion'); ?></label>
...
} // Class anipat_social_links ends here


// Register and load the widget
function anipat_social_links_widget_load() {
	register_widget( 'Anipat_social_links' );
}
add_action( 'widgets_init', 'anipat_social_links_widget_load' );