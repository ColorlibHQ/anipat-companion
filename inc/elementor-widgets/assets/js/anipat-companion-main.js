(function ($) {
    ...
    if ($.fn.owlCarousel) {
        $(".anipat-service-slides").owlCarousel({
            items: 3,
            loop: true,
            autoplay: true,
            smartSpeed: 800,
    ...
    if ($.fn.owlCarousel) {
        $(".anipat-workflow-slides").owlCarousel({
            items: 3,
            loop: true,
            autoplay: true,
            smartSpeed: 800,
    ...
    if ($.fn.owlCarousel) {
        $(".anipat-team-slides").owlCarousel({
            items: 3,
            loop: true,
            autoplay: true,
            smartSpeed: 800,
    ...
    if ($.fn.imagesLoaded) {
        $('.anipat-portfolio').imagesLoaded(function () {
            ...
            // init Isotope
            var $grid = $('.anipat-portfolio').isotope({
    ...
    // MC Scripts
    var $subscribe = $('.anipat-subscribe-newsletter-area');
    if ($subscribe.length) {
